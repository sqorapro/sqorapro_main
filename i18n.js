...
const CONTENT = {
  ...
  ru: {
    ...
    work: {
      ...
      m2_label: "менторов подключено",
      m3_label: "недели до запуска",
      m4_label: "дешевле SaaS-аналогов",
    ...
    products: {
      ...
      skidqi_desc: "Маркетплейс акций и скидок, где каждое объявление показывает честную цену: до и после.",
